...
public class TestTransferMessageClientSender2 extends TestCase {
	 ...
	 * @param name
	 */
	public TestTransferMessageClientSender2(String name) {
		super(name);
		// 引数に送信するコマンド、金額、コメントを入れる
		sender = new TransferMessageClientSender("receive", account, amount,
				comment);
	}
